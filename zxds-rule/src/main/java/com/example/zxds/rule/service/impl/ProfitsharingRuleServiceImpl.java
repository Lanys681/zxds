...
import com.example.zxds.rule.db.dao.OrderCommentDao;
import com.example.zxds.rule.db.dao.OrderDao;
import com.example.zxds.rule.db.dao.ProfitsharingRuleDao;
...
public class ProfitsharingRuleServiceImpl implements ProfitsharingRuleService {
    ...
    public HashMap calculateProfitsharing(long orderId, String amount,String key) {
        ...
        try {
            ...
            throw new ZxdsException("计算订单分账失败");
        }
    }
