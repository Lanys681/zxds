...
import com.example.zxds.mis.api.db.dao.RoleDao;
import com.example.zxds.mis.api.db.pojo.RoleEntity;
import com.example.zxds.mis.api.service.RoleService;
...
//        map.replace("permissions",JSONUtil.parseArray("permissions"));
    ...
    public int deleteRoleByIds(Integer[] ids) {
        if (!roleDao.searchCanDelete(ids)) {
            throw new ZxdsException("无法删除关联用户的角色");
        }
